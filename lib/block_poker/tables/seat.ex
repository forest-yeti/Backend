defmodule BlockPoker.Tables.Seat do
  ...
  не зачислены; `:queued` — деньги списаны, но раздача уже шла, и фишки лягут
  на стол в начале следующей; `:settled` — зачислены. Ключ переживает зачисление именно
